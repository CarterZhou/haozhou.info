...
@section('pageTitle')
    <h3>Post page <small>update a post</small></h3>
@endsection
        ...
        <form class="form-horizontal form-label-left" method="post" action="{{ route('updatePost', ['id' => $post->id]) }}">
            ...
            <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="title" class="form-control col-md-7 col-xs-12" name="title" value="{{ old('title')?:$post->title}}">
            ...
            <div class="form-group {{ $errors->has('body') ? 'has-error' : ''}}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea class="form-control" rows="10" name="body">{{ old('body')?:$post->body }}</textarea>
